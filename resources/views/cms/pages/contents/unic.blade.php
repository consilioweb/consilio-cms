		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					...
					@if(isset($contents))
					{!! Form::model($contents, ['route' => ['cms-contents-unic-update', $module->modules_id], 'method' => 'put', 'files' => true]) !!}
					@else
					{!! Form::open(['method' => 'post', 'autocomplete' => 'off', 'route' => ['cms-contents-unic-create', $module->modules_id], 'files' => true]) !!}
					@endif
					...
					<div class="form-group row">
						...
						<div class="col-10 border-preview-img">
							...
							<div id="image-holder">				 				
								...
								<div class="btn-thumb">
									<a style="margin-bottom: 7px;" href="{!!route('cms-contents-unic-delete-photo',  array($module->modules_id, $contents->contents_id))!!}" class="btn waves-effect waves-light btn-dark"><i class="icon-trash"></i> Excluir</a>
								</div>
