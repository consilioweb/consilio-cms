...
Route::group(['namespace' => 'Cms', 'prefix' => 'cms'], function() {
	...
	Route::group(['middleware' => 'auth:cms'], function() {
		...
		Route::get('gerenciar/excluir/foto/{modules_id}/{contents_id}', array('as' => 'cms-contents-list-delete-photo', 'uses' => 'ContentsListController@destroyPhoto', 'nickname' => "Excluir Conteudo"));
